...
must_haves:
  ...
  key_links:
    ...
    # Navigation wiring (documented here, wired in 07-04):
    # - Step's onComplete prop -> wizard's goToNext() (steps 1-2) or handleComplete() (step 3)
    # - Step's onSkip prop -> wizard's goToNext()
    # This callback pattern allows steps to remain independent of navigation logic
---
...
import type { BusinessActionState } from '@/lib/actions/business'
