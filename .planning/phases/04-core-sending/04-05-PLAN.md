...
must_haves:
  ...
  artifacts:
    ...
    - path: "components/send/message-preview.tsx"
      provides: "Email preview with edit capability"
      min_lines: 50
  key_links:
      ...
      <div className="p-6 bg-gray-50">
        <div className="bg-white rounded-lg p-6 shadow-sm max-w-lg mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for choosing {business.name}! We&apos;d really appreciate it if
...
```
  ...
  <done>Message preview shows editable subject and email content; SendForm orchestrates full send flow with success/error states</done>
</task>
...
6. Subject editing works
7. Send button triggers Server Action
