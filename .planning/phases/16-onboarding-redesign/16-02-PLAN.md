...
NOTE: This plan depends on 16-01 because the migration changes the `onboarding_steps_completed` JSONB default from array `[]` to object `{}` format. The wizard and data layer must use the object format.
</objective>
...
@.planning/phases/16-onboarding-redesign/16-01-SUMMARY.md
@app/(dashboard)/onboarding/page.tsx
@components/onboarding/onboarding-wizard.tsx
@components/onboarding/onboarding-progress.tsx
@components/onboarding/onboarding-steps.tsx
