...
must_haves:
  truths:
    ...
    - "Zod schemas define structured output format"
  artifacts:
    ...
    - path: "lib/ai/schemas.ts"
      ...
      exports: ["PersonalizedMessageSchema", "PersonalizedEmailSchema", "PersonalizedSmsSchema"]
  key_links:
...
- Moderate rewrite level (restructure, vary phrasing, add warmth)
...
File exports EMAIL_SYSTEM_PROMPT, SMS_SYSTEM_PROMPT, buildPersonalizationPrompt.
  ...
  <done>System prompts define personalization behavior for email and SMS with guardrails</done>
</task>
