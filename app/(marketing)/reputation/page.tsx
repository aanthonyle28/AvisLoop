...
export const metadata: Metadata = {
  title:
    "AvisLoop — Managed Google Review Service for Home Service Businesses | Reputation Management",
  description:
  ...
  alternates: {
    canonical: `${baseUrl}/reputation`,
  },
  openGraph: {
    title:
      "AvisLoop — Managed Google Review Service for Home Service Businesses",
    description:
